...
OrderRequestBuilder.prototype.buildConsumer = function (basket) {
    ...
    var customerEmail = Resource.msg('dummy.email.id', 'clearpay', null);
...
OrderRequestBuilder.prototype.buildMerchantInformation = function (url) {
    this.context.merchant.redirectConfirmUrl = !empty(url) ? url : clearpayWebServiceUtilities.getRedirectConfirmUrl();
    this.context.merchant.redirectCancelUrl = !empty(url) ? url : clearpayWebServiceUtilities.getRedirectCancelUrl();
