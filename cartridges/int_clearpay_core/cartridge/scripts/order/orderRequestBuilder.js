 ...
 * @returns {Object} - this object
 */
OrderRequestBuilder.prototype.buildMerchantInformation = function () {
    var merchantURL = sitePreferencesUtilities.getRedirectConfirmUrl();
...
OrderRequestBuilder.prototype.buildInitialOrderAmount = function (basket) {
    ...
    var preOrderHelper = require('*/cartridge/scripts/checkout/clearpayPreOrderHelpers');
