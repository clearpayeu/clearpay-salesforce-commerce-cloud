...
describe('Retrieves token', function () {
    ...
    before(function () {
        ...
        .then(function () {
            ...
            myRequest.form = {
                ...
                dwfrm_billing_paymentMethod: 'CLEARPAY_PBI',
                dwfrm_billing_contactInfoFields_email: 'blahblah@gmail.com',
                dwfrm_billing_clearpayFields_clearpayEmail: 'blahblah@gmail.com',
        ...
        .then(function () {
            myRequest.url = config.baseUrl + '/ClearpayRedirect-IsClearpay?' +
	            myRequest.csrf.tokenName + '=' +
	            myRequest.csrf.token;
            myRequest.form = {};
            return request(myRequest);
    ...
    it('should process request and retrieve token', function(done){
    	myRequest.url = config.baseUrl + '/ClearpayRedirect-Redirect?' +
	        myRequest.csrf.tokenName + '=' +
	        myRequest.csrf.token;
