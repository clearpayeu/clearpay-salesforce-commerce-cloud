...
describe('Saves clearpay payment method', function () {
    this.timeout(10000);
    ...
    it('should save clearpay payment method in payment instrument', function () {
        ...
        request(myRequest, function (error, response) {
            ...
            assert.isTrue(bodyAsJson.isClearpay);
        });
    });
});
